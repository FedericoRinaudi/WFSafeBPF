...
int main(int argc, char **argv) 
{
    ...
    int prog_fd, map_fd;
    int err = 0;
    const char *filename = "blake2s_reference_test.bpf.o";
    
    printf("Blake2s eBPF Reference Test\n");
    printf("===========================\n");
    ...
    prog = bpf_object__find_program_by_name(obj, "blake2s_reference_test_prog");
    if (!prog) {
